...
export default function JobCategories() {
  return (
    <section className="w-full py-12 px-4 md:px-0 flex flex-col items-center">
      <h2 className="text-2xl md:text-4xl text-blue-700-custom mb-2 text-center">Job Categories We Provide</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl w-full">
        {categories.map((cat, idx) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-1 text-center">{cat.title}</h3>
          </div>
        ))}
      </div>
    </section>
